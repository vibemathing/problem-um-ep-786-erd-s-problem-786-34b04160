...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-786-erd-s-problem-786-34b04160-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-786"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-786-erd-s-problem-786-34b04160-v1",
      "problem_contract_sha256": "0e8b1c94ecb02b261980d883aee4e8e3e2dfb0db3cff7b2d388f794f8b86b6d4",
      "problem_id": "problem:um-ep-786-erd-s-problem-786-34b04160",
      "route_id": "route:um-ep-786-erd-s-problem-786-34b04160-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-786-erd-s-problem-786-34b04160-source-fidelity-01",
      "graph_id": "graph:um-ep-786-erd-s-problem-786-34b04160-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-786-erd-s-problem-786-34b04160-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-786-erd-s-problem-786-34b04160-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\epsilon>0$. Is there some set $A\\subset \\mathbb{N}$ of density $>1-\\epsilon$ such that $a_1\\cdots a_r=b_1\\cdots b_s$ with $a_i,b_j\\in A$ can only hold when $r=s$? Similarly, can one always find a set $A\\subset\\{1,\\ldots,N\\}$ with this property of size $\\geq (1-o(1))N$?"
          },
          "statement_sha256": "4c81ffd7f7554c4fad27540d97deff3c29f3ef2c8d8eb6235b6d9c12bbac21bc"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-786-erd-s-problem-786-34b04160-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-786-erd-s-problem-786-34b04160-root",
      "route_id": "route:um-ep-786-erd-s-problem-786-34b04160-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-786-3798ad51fd68",
        "url": "https://www.unsolvedmath.com/problems/EP-786"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
